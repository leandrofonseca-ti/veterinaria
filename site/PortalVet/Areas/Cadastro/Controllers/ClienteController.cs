...
namespace PortalVet.Areas.Cadastro.Controllers
{
    public class ClienteController : BaseController
    {
        ...
        public ClienteController(IAdminUserService adminUserService)
        {
        ...
        public LargeJsonResult List(FormCollection form)
        {
            ...
            var filterPerfilID = EnumAdminProfile.Cliente;
        ...
        public LargeJsonResult Remove(FormCollection form)
        {
            ...
            try
            {
                if (form["id"] != null)
                {
                    ...
                    _adminUserService.DesvincularAdminUserProfile(id, EnumAdminProfile.Cliente, SessionsAdmin.EmpresaId);
                }
            }
            catch (Exception ex)
            {
        ...
        public LargeJsonResult Save(FormCollection form)
        {
            ...
            if (!jsonResultado.Criticas.Any())
            {
                ...
                entity = _adminUserService.SaveUserPerfil(new AdminUserItem()
                {
                    Id = codigo,
