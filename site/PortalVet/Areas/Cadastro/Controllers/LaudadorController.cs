...
{
    public class LaudadorController : BaseController
    {
        public string _pathFolderUser = "user";

        private readonly IAdminUserService _adminUserService;

        public LaudadorController(IAdminUserService adminUserService)
        {
        ...
        public LargeJsonResult List(FormCollection form)
        {
            ...
            var filterPerfilID = EnumAdminProfile.Laudador;
        ...
        public LargeJsonResult Remove(FormCollection form)
        {
            ...
            try
            {
                if (form["id"] != null)
                {
                    ...
                    _adminUserService.DesvincularAdminUserProfile(id, EnumAdminProfile.Laudador, SessionsAdmin.EmpresaId);
                }
            }
            catch (Exception ex)
            {
        ...
        public LargeJsonResult Save(FormCollection form)
        {
            ...
            if (form["txtCPFCNPJ"].Trim().Length.Equals(0))
            {
                emptyCPFCNPJ = true;
            ...
            if (!jsonResultado.Criticas.Any())
            {
                ...
                entity = _adminUserService.SaveUserPerfil(registroLaudador, out message, out idexist);
                ...
                else
                {
                    if (codigo == 0)
                    {
                        ...
                        sbText.AppendLine($"ATENÇÃO LAUDADOR<br/><br/>");
                        ...
                        sbText.AppendLine("E-mail: <strong>" + registroLaudador.Email + "</strong><br/>");
