...
//------------------------------------------------------------------------------
        ...
        var _generateExpand = function(){
            ...
            return $('<li class="positionExpand"></li>').append(control);
        };
...
//------------------------------------------------------------------------------
    ...
    $.fn.lobiPanel.DEFAULTS = {
        ...
        //},
        minimize: {
            icon: '', //icon is shown when panel is not minimized
            icon2: '', //icon2 is shown when panel is minimized
            tooltip: ''         //tooltip text, If you want to disable tooltip, set it to false
        },
        expand: {
